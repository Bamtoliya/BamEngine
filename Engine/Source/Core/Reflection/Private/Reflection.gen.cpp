...
BEGIN_PROPERTIES(MaterialInstance)
	REFLECT_PROPERTY(MaterialInstance, m_BaseMaterialHandle, "ResourceHandle<Material>", Engine::EPropertyType::ResourceHandle, {})
...
BEGIN_PROPERTIES(Sprite)
	REFLECT_PROPERTY(Sprite, m_Texture, "ResourceHandle<Texture>", Engine::EPropertyType::ResourceHandle, Sprite_m_Texture_Meta)
